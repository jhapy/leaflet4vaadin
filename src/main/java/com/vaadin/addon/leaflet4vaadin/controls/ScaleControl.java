 ...
 * imperial (mi/ft) systems. Extends Control.
 *
...
public class ScaleControl extends LeafletControl {
  ...
  /**
   * Maximum width of the control in pixels. The width is set dynamically to show round values (e.g.
   * 100, 200, 500).
   *
  ...
  /**
   * If true, the control is updated on moveend, otherwise it's always up-to-date (updated on
   * move).
   *
