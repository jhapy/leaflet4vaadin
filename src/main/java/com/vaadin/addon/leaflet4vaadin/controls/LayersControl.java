 ...
 * overlays on/off (check out the detailed example). Extends Control. <br>
 * <br>
 * The baseLayers and overlays parameters are object literals with layer names as keys and Layer
 * objects as values. <br>
 * <br>
...
public class LayersControl extends LeafletControl {
   ...
   *
   * @param layer the layer to be added to map as a base layer
   ...
   *
   * @param layer the layer to be added to map as an overlay
