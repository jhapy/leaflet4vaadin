 ...
 * canvas instead of DOM. Working with Leaflet 1.0.0 and above. Feel free to contribute. Github: <a
 * href= "https://github.com/eJuke/Leaflet.Canvas-Markers">https://github.com/eJuke/Leaflet.Canvas-Markers</a>
 *
 * <h3>Methods</h3>
 * <ul>
...
public class CanvasIconLayer extends Layer {
   ...
   *
   * @param marker The marker to be added to this layer
   */
  ...
  /**
   * Removes a marker from the layer. Set redraw to true if you want to redraw layer after marker
   * remove
   *
   * @param marker The marker to be removed from the layer
   * @param redraw If true the redraw() function will be called on client side after marker remove
   */
  ...
  /**
   * Get the makers. If you want to remove a maker you should use the removeMarker(marker) method.
   *
