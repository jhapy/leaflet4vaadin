 ...
 * Inherits from Icon but ignores the iconUrl and shadow options. <br>
 * <br>
 * By default, it has a 'leaflet-div-icon' CSS class and is styled as a little white square with a
 * shadow.
 *
 *
 * <h3>Usage example</h3>
...
public class DivIcon extends Icon {
  ...
  /**
   * Sets the custom HTML code to put inside the div element, empty by default. Alternatively, an
   * instance of HTMLElement.
   *
   * @param html custom HTML code to put inside the div
   */
   ...
   *
   * @param bgPos the position of the background to be used
   */
