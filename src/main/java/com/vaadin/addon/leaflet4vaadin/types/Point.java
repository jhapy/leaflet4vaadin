...
public class Point implements BasicType {
  ...
  /**
   * Returns `true` if both coordinates of the given point are less than the corresponding current
   * point coordinates (in absolute values).
   *
   * @param point a valid point
   * @return true if both coordiantes of the given point are less than current point coordinates
   */
