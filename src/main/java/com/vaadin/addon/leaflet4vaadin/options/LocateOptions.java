...
public class LocateOptions implements Serializable {
  ...
  /**
   * If true, starts continuous watching of location changes (instead of detecting it once) using
   * W3C watchPosition method. You can later stop watching using map.stopLocate() method.
   *
  ...
  /**
   * If true, automatically sets the map view to the user location with respect to detection
   * accuracy, or to world view if geolocation failed.
   *
