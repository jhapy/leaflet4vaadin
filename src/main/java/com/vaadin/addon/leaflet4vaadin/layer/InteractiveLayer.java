...
/**
 * Some Layers can be made interactive - when the user interacts with such a layer, mouse events
 * like click and mouseover can be handled. Use the event handling methods to handle these events.
 *
