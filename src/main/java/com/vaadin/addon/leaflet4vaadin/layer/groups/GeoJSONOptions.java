...
public class GeoJSONOptions implements Serializable {
  ...
  /**
   * A Function that will be used for converting GeoJSON coordinates to LatLngs. The default is the
  ...
  /**
   * A Function defining the Path options for styling GeoJSON lines and polygons, called internally
  ...
  /**
   * A Function defining how GeoJSON points spawn Leaflet layers. It is internally called when data
   * is added, passing the GeoJSON point feature and its LatLng. The default is to spawn a default
   * Marker:
   *
  ...
  /**
   * A Function that will be used to decide whether to include a feature or not. The default is to
   * include all features: Note: dynamically changing the filter option will have effect only on
  ...
  /**
   * A Function that will be called once for each created Feature, after it has been created and
   * styled. Useful for attaching events and popups to features. The default is to do nothing with
  ...
  /**
   * Callback function that will be used for converting GeoJSON coordinates to LatLngs.
   */
  @FunctionalInterface
