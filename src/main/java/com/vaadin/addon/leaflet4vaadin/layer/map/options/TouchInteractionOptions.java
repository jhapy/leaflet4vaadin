...
public interface TouchInteractionOptions {
  ...
  /**
   * The max number of pixels a user can shift his finger during touch for it to be considered a
   * valid tap.
   *
   * @param tapTolerance The max number of pixels a user can shift his finger during touch
   */
  ...
  /**
   * Whether the map can be zoomed by touch-dragging with two fingers. If passed 'center', it will
   * zoom to the center of the view regardless of where the touch events (fingers) were. Enabled for
   * touch-capable web browsers except for old Androids.
   *
   * @param touchZoom Whether the map can be zoomed by touch-dragging with two fingers
   */
