 ...
 * which you can set under Layer. Extends GridLayer.
 *
...
public class TileLayer extends GridLayer {
  ...
  /**
   * Whether the crossOrigin attribute will be added to the tiles. If a String is provided, all
   * tiles will have their crossOrigin attribute set to the String provided. This is needed if you
   * want to access tile pixel data. Refer to CORS Settings for valid String values.
   *
