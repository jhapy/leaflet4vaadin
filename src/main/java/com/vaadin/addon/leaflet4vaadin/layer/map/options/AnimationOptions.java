...
public interface AnimationOptions extends Serializable {
  ...
  /**
   * Whether the map zoom animation is enabled. By default it's enabled in all browsers that support
   * CSS3 Transitions except Android.
   *
   ...
   * support CSS3 Transitions except Android.
   *
  ...
  /**
   * Whether markers animate their zoom with the zoom animation, if disabled they will disappear for
   * the length of the animation. By default it's enabled in all browsers that support CSS3
   * Transitions except Android.
   *
   * @param markerZoomAnimation if true markers will animate their zoom with the zoom animation
   */
  ...
  /**
   * Defines the maximum size of a CSS translation transform. The default value should not be
   * changed unless a web browser positions layers in the wrong place after doing a large panBy.
   *
