...
public interface MapStateOptions extends Serializable {
  ...
  /**
   * Minimum zoom level of the map. If not specified and at least one GridLayer or TileLayer is in
   * the map, the lowest of their minZoom options will be used instead.
   *
  ...
  /**
   * Maximum zoom level of the map. If not specified and at least one GridLayer or TileLayer is in
   * the map, the highest of their maxZoom options will be used instead.
   *
  ...
  /**
   * When this option is set, the map restricts the view to the given geographical bounds, bouncing
   * the user back if the user tries to pan outside the view. To set the restriction dynamically,
   * use setMaxBounds method.
   *
