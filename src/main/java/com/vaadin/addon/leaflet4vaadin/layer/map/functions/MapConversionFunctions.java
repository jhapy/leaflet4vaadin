...
public interface MapConversionFunctions extends ExecutableFunctions {
  ...
  /**
   * Projects a geographical coordinate LatLng according to the projection of the map's CRS, then
   * scales it according to zoom and the CRS's Transformation. The result is pixel coordinate
   * relative to the CRS origin.
   *
  ...
  /**
   * Given a pixel coordinate relative to the origin pixel, returns the corresponding geographical
   * coordinate (for the current zoom level).
   *
  ...
  /**
   * Given a geographical coordinate, returns the corresponding pixel coordinate relative to the
   * origin pixel.
   *
  ...
  /**
   * Returns a LatLng where lat and lng has been wrapped according to the map's CRS's wrapLat and
   * wrapLng properties, if they are outside the CRS's bounds. By default this means longitude is
   * wrapped around the dateline so its value is between -180 and +180 degrees.
   *
   * @param latLng a geographical coordinate
  ...
  /**
   * Returns a LatLngBounds with the same size as the given one, ensuring that its center is within
   * the CRS's bounds. By default this means the center longitude is wrapped around the dateline so
   * its value is between -180 and +180 degrees, and the majority of the bounds overlaps the CRS's
   * bounds.
   *
  ...
  /**
   * Returns the distance between two geographical coordinates according to the map's CRS. By
   * default this measures distance in meters.
   *
  ...
  /**
   * Given a pixel coordinate relative to the map container, returns the corresponding pixel
  ...
  /**
   * Given a pixel coordinate relative to the origin pixel, returns the corresponding pixel
  ...
  /**
   * Given a pixel coordinate relative to the map container, returns the corresponding geographical
   * coordinate (for the current zoom level).
   *
   * @param point a pixel coordinate relative to the map container
   * @return the corresponding geographical coordinate (for the current zoom level)
   * @see Point
   * @see LatLng
   */
  ...
  /**
   * Given a geographical coordinate, returns the corresponding pixel coordinate relative to the map
   * container.
   *
   * @param latLng a geographical coordinate
   * @return the corresponding pixel coordinate relative to the map container
  ...
  /**
   * Given a MouseEvent object, returns the pixel coordinate relative to the map container where the
   * event took place.
   *
   * @param mouseEvent a MouseEvent object
   * @return the pixel coordinate relative to the map container where the event took place
   * @see Point
   * @see LatLng
   */
  ...
  /**
   * Given a MouseEvent object, returns the pixel coordinate relative to the origin pixel where the
   * event took place.
   *
   * @param mouseEvent a MouseEvent object
