...
/**
 * A set of methods from the Layer base class that all Leaflet layers use. Inherits all methods,
 * options and events from L.Evented.
 *
 ...
 * @since 2020-02-06
 */
public abstract class Layer extends LeafletObject implements Evented, LayerPopupFunctions,
    LayerTooltipFunctions {
