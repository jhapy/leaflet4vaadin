...
public interface MapGetStateFunctions extends ExecutableFunctions {
  ...
  /**
   * Returns the minimum zoom level of the map (if set in the minZoom option of the map or of any
   * layers), or 0 by default.
   *
  ...
  /**
   * Returns the maximum zoom level of the map (if set in the maxZoom option of the map or of any
   * layers).
   *
   ...
   * If inside (optional) is set to true, the method instead returns the minimum zoom level on which
   * the map view fits into the given bounds in its entirety.
   *
   * @param bounds the bounds
   * @param inside the inside
   * @param padding the padding
   * @return the maximum zoom level on which the given bounds fit to the map view in its entirety
   */
  default CompletableFuture<Double> getBoundsZoom(LatLngBounds bounds, boolean inside,
      Point padding) {
  ...
  /**
   * Returns the bounds of the current map view in projected pixel coordinates (sometimes useful in
   * layer and overlay implementations).
   *
  ...
  /**
   * Returns the projected pixel coordinates of the top left point of the map layer (useful in
   * custom layer and overlay implementations).
   *
  ...
  /**
   * Returns the world's bounds in pixel coordinates for zoom level zoom. If zoom is omitted, the
   * map's current zoom level is used.
   *
