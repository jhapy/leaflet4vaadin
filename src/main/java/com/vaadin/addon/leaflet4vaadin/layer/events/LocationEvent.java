...
public class LocationEvent extends LeafletEvent {
  ...
  public LocationEvent(Layer layer, LocationEventType eventType, LatLng latlng, LatLngBounds bounds,
      Double accuracy,
  ...
  public String toString() {
    return "LocationEvent [type=" + super.getType() + ", accuracy=" + accuracy + ", altitude="
        + altitude
        + ", altitudeAccuracy=" + altitudeAccuracy + ", bounds=" + bounds + ", heading=" + heading
        + ", latlng="
