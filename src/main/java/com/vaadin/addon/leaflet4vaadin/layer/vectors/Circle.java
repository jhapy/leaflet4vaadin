...
/**
 * A class for drawing circle overlays on a map. Extends CircleMarker. It's an approximation and
 * starts to diverge from a real circle closer to poles (due to projection distortion).
 */
