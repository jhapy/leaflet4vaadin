...
public class ImageOverlay extends InteractiveLayer {
  ...
  /**
   * Instantiates an image overlay object given the URL of the image and the geographical bounds it
   * is tied to.
   *
   ...
   * image will have its crossOrigin attribute set to the String provided. This is needed if you
   * want to access image pixel data. Refer to CORS Settings for valid String values.
   *
