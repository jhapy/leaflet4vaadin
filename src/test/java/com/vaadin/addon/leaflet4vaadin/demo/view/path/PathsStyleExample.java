...
public class PathsStyleExample extends ExampleContainer {
  ...
  private void createFormControls(Binder<PathOptions> binder) {
    ...
    Select<String> strokeColor = new Select<>("red", "blue", "white", "green", "yellow", "gray",
        "black");
    ...
    Select<String> fillColor = new Select<>("red", "blue", "white", "green", "yellow", "gray",
        "black");
    ...
    binder.forField(fillOpacity)
        .bind((o) -> o.getFillOpacity() * 100, (o, v) -> o.setFillOpacity(v / 100));
