...
public class SourceCodeViewer extends VerticalLayout {
  ...
  private String getSourceCode() throws Exception {
    ...
    while ((inputLine = in.readLine()) != null) {
      ...
      if (inputLine.startsWith("import ") || inputLine.startsWith("// ") || inputLine
          .startsWith("package ")) {
        continue;
      }
  ...
  private String highlightJava(String inputLine) {
    ...
    inputLine = highlightKeywords(inputLine, keywordColor, "public", "private", "protected",
        "final", "new",
        "return", "continue", "extends", "implements", "null", "throws", "throw", "static", "void",
        "abstract",
        "instanceof", "volatile", "transient", "synchronized", "strictfp", "package", "native",
        "interface",
        "goto", "enum", "const", "assert");

    inputLine = highlightBlockKeywords(inputLine, keywordColor, "if", "else", "else if", "while",
        "for", "try",
        "case", "break", "default", "catch", "switch", "finally", "do");

    inputLine = highlightInstanceKeywords(inputLine, keywordColor, "true", "false", "class", "this",
        "super");

    inputLine = highlightTypes(inputLine, typeColor, "long", "int", "short", "double", "float",
        "byte", "char",
        "String");
