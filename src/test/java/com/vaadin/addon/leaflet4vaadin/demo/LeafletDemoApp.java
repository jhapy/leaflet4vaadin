...
public class LeafletDemoApp extends AppLayout implements AfterNavigationObserver {
  ...
  private void initActionButtons() {
    ...
    directoryButton.addClickListener(
        (e) -> UI.getCurrent().getPage()
            .setLocation("https://vaadin.com/directory/component/leaflet4vaadin"));
  ...
  private void initializeDemoMenu() {
    ...
    // Marker examples
    AppMenuItem.create("Markers", new Icon(VaadinIcon.MAP_MARKER))
        .addSubMenu(MarkersSimpleExample.class)
    ...
    AppMenuItem.create("Controls", new Icon(VaadinIcon.ARROWS))
        ...
        .addSubMenu(ControlPositionExample.class).addSubMenu(ScaleControlExample.class)
        .addTo(appMenu);

    // Mixins examples
    AppMenuItem.create("Mixin", new Icon(VaadinIcon.SHIELD)).addSubMenu(WorldMapFlagsExample.class)
        .addTo(appMenu);

    // Plugins examples
    AppMenuItem.create("Plugins", new Icon(VaadinIcon.PLUG))
        .addSubMenu(FullScreenPluginExample.class)
